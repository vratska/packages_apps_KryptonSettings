...
abstract class GamingModeBaseAppListFragment: AppListFragment() {

    override protected fun getInitialCheckedList(): List<String> {
        val flattenedString = Settings.System.getStringForUser(
            context!!.contentResolver, getKey(),
            UserHandle.USER_CURRENT)
        return flattenedString?.takeIf {
            it.isNotBlank()
        }?.split(";")?.toList() ?: emptyList<String>()
    }
    ...
    abstract protected fun getKey(): String
}